...
Game.NS_INT_9_G6level1=function(){};


Game.NS_INT_9_G6level1.prototype =
{
    ...
    init:function(game)
    {
        ...
        telInitializerbbpp.gameIdInit("NS_INT_9_G6", gradeSelected);
	...
	create:function(game)
    {
       ...
       // _this.grade;
        ...
        _this.square3=_this.add.image(-200,-220,'highlightBox');
        _this.square3.scale.setTo(0.8,0.7);
        _this.square3.visibile = false;
        
        _this.square4=_this.add.image(-200,-220,'highlightBox');
        _this.square4.scale.setTo(1.1,0.7);
        _this.square4.visibile = false;

        _this.square5=_this.add.sprite(-200,-220,'highlightBox');
    ...
    tickbtn_Clicked_and_evaluation:function()
    {
        ...
        for(var i=0;i<_this.obj_group1.length;i++)
        {
            ...
            else if(_this.object_sign_box1[_this.obj_group1.getChildAt(i).name]==0)
            {
                countm+=1;
        ...
        if(j==1)
        {
            for(var i=0;i<_this.obj_group2.length;i++)
            {
                ...
                else if(_this.object_sign_box2[_this.obj_group2.getChildAt(i).name]==0)
                {
                    countm+=1;
    ...
    ShowDragAction:function()
    {
         ...
         dragPlusDragAction.start();
            ...
            var dragMinus = _this.add.sprite(201,85,'minus')
    ...
    gotoaddingInteger:function()
    {
        ...
        if(_this.box1Array[_this.flag1]==_this.box2Array[_this.flag2])
        {
            _this.element2=_this.box2Array[_this.flag2+1]
            // console.log("check random")
            // console.log(_this.element2)
        }
        
        if(_this.element1>_this.element2){
            _this.sign1="-";
            _this.sign2="+";
        }
        else{
        ...
        _this.Txt1 = _this.add.text(28,33,_this.sign1+_this.element1,{ fontSize: '30px', font: 'Akzidenz-Grotesk BQ'});
        _this.Txt2 = _this.add.text(120,33,"("+_this.sign2+_this.element2+")",{ fontSize: '30px', font: 'Akzidenz-Grotesk BQ'});
        ...
        _this.plus_sign=_this.add.text(88,33,"+", { fontSize: '30px', font: "Akzidenz-Grotesk BQ"});
    ...
    evaluation1:function()
    {
        ...
        if((_this.element1-_this.element2)<0)
        {
            ...
            console.log("Addition answer if less than 0")
    ...
    evaluation2:function()
    {
        ...
        if((_this.element1-_this.element2)<0)
        {
            ...
            {
                console.log("enter first if box2")
                for(_this.j=0;(_this.j<_this.obj_group2.length);_this.j++)
                {
                    console.log("enter for box2")
                    if(_this.object_sign_box2[Number(_this.obj_group2.getChildAt(_this.j).name)]==1){
                        _this.ans+=1;
                        console.log("ans")
                        console.log( _this.ans)
                    }
                    else if(_this.object_sign_box2[Number(_this.obj_group2.getChildAt(_this.j).name)]==0){
                        _this.ans+=1;
                ...
                {
                    console.log("ans equal sum of given element")
                    return 1;
                }
                else
                {
        ...
        {        
            if(_this.obj_group2.length==0&&_this.obj_group1.length==(_this.element1-_this.element2))
            {
                ...
                for(_this.j=0;(_this.j<_this.obj_group1.length);_this.j++)
                {
                    ...
                    else if(_this.object_sign_box1[Number(_this.obj_group1.getChildAt(_this.j).name)]==0)
                    {
                        _this.ans+=1;
                        console.log("minus ans")
                        console.log( _this.ans)
    ...
    celebration:function()
    {
        ...
        else if(_this.element2-_this.element1<0){
            _this.obj_group1.removeAll();
    ...
    rightbtnClicked:function()
    {
        ...
        if(_this.evaluation1()&&_this.evaluation2())
        {
           ...
           telInitializerbbpp.tele_saveAssessment(_this.questionid, "yes", _this.AnsTimerCount, _this.noofAttempts, _this.sceneCount);
            ...
            _this.time.events.add(2600,function()
            {
                _this.Txt1.destroy();
                _this.Txt2.destroy();
                _this.plus_sign.destroy();
                _this.equalTo.destroy();
                _this.Question_AnswerBox.frame=1;
...
//                _this.time.events.add(5000,function(){ window.parent.location.reload();});
    ...
    {          
        if(_this.checkOverlap(target, _this.rectangleBox1) && _this.obj_group1.length < _this.element1)
        {    
    ...
    { 
        ...
        else if(_this.checkOverlap(target, _this.rectangleBox2) && _this.obj_group1.length >= _this.element1)
        {
            for(_this.i=0;_this.i<=15&&_this.object_present_box2[_this.i]!=0;_this.i++);
