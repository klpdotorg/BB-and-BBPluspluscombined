Game.ALM_02_FIB_G6level1 = function () { };


Game.ALM_02_FIB_G6level1.prototype =
{
    ...
    init: function (game) {
        ...
        telInitializerbbpp.gameIdInit("ALM_02_G6", gradeSelected);
    ...
    gameCreate: function (game) {
        ...
        _this.FishInSmallTank_X = [380, 427, 380, 427, 380];//[20,82,20,82,20]////[80,140,80,140,80];
        _this.FishInSmallTank_Y = [162, 162, 135, 135, 108];//[210,210,175,175,140];

        _this.FishInSecondSmallTank_X = [568, 620, 568, 620, 568];//[20,80,20,80,20];
        _this.FishInThirdSmallTank_X = [768, 820, 768, 820, 768];
        _this.FishInFourthSmallTank_X = [380, 427, 380, 427, 380];
        ...
        _this.FIBTypeArrayCount_A = 0;
        _this.FIBTypeArrayCount_B = 0;

        _this.PartA_initialEvaluation = 1;
        _this.PartA_secondEvaluation = 0;
        _this.commonPart = 1;

        _this.PartB_initialEvaluation = 1;
        _this.PartB_secondEvaluation = 0;
    ...
    randomizing_elements_PartA: function () {
        ...
        for (i = 0; i < 3; i++) {
            _this.Z = Math.floor(Math.random() * (6 - 2) + 2);
            ...
            for (j = 0; j < _this.YArray.length; j++) {
                if (_this.Y == _this.YArray[j]) {
                    _this.Y = Math.floor((Math.random() * (7 - 2)) + 2);
                    j = -1;
                }
            }
        ...
        console.log(_this.ZArray);
        console.log(_this.YArray);
        console.log(_this.XArray);
    },

    loadingPartAObject: function () {
        _this.PartB = 0;
        _this.PartA = 1;
        _this.ArrayFirstBox = [0, 0, 0, 0, 0];
        _this.ArraySecondBox = [0, 0, 0, 0, 0];
        _this.ArrayThirdBox = [0, 0, 0, 0, 0, 0];
        _this.ArrayFourthBox = [0, 0, 0, 0, 0, 0];
        _this.ArrayFifthBox = [0, 0, 0, 0, 0, 0];
        _this.ArraySixthBox = [0, 0, 0, 0, 0, 0];
    ...
    Overlap_FistSmallTank: function (target) {
        ...
        if (_this.checkOverlap(target, _this.FirstSmallTank) && _this.FirstSmallTankFishGrp.length <= 4) {
    ...
    rightbtnClicked: function () {
        ...
        if (_this.PartA == 1) {
            ...
            if (_this.PartA_initialEvaluation == 1) {
                console.log(Number("" + _this.selectedAns1 + _this.selectedAns2), _this.ZArray[_this.PartAQnCnt])
                if (_this.AnswerBox.name == _this.ZArray[_this.PartAQnCnt]) {
                    console.log("currect ans entered");

                    _this.PartA_initialEvaluation = 0;
                    _this.commonPart = 0;
                    if (_this.count1 == 0) {
                        _this.Question_flag = -1;
                        _this.VoiceNote3Fn();
            ...
            else if (_this.PartA_secondEvaluation == 1) {
                console.log("val2")
                console.log(Number('' + _this.selectedAns1 + _this.selectedAns2));
                _this.partAValidation2();
            }
        }
        ...
        if (_this.PartB == 1) {
            ...
            if (_this.PartB_initialEvaluation == 1) {
                ...
                if (_this.AnswerBox.name == _this.YArray_PartB[_this.PartBQnCnt]) {
                    console.log("currect ans entered");
                    _this.PartB_initialEvaluation = 0;
                    _this.commonPart = 0;
            ...
            else if (_this.PartB_secondEvaluation == 1) {
                _this.partBValidation2();
            }
        }
    },

    partAValidation2: function () {
        _this.Question_flag = 3;
        console.log(_this.FIBType_A, Number('' + _this.selectedAns1 + _this.selectedAns2))
        if (_this.FIBType_A == 1) {
            console.log(_this.AnswerBox.name);
            // if(Number("" +var_selectedAns1+var_selectedAns2) == _this.YArray[_this.PartAQnCnt])
            // if(_this.AnswerBox.name == _this.YArray[_this.PartAQnCnt])
            if (_this.AnswerBox.name == _this.YArray[_this.PartAQnCnt]) {
        ...
        if (_this.FIBType_A == 2) {
            console.log(_this.AnswerBox.name);
            if (_this.AnswerBox.name == _this.XArray[_this.PartAQnCnt])
            // if(_this.AnswerBox.name == _this.XArray[_this.PartAQnCnt])
            {
        ...
        if (_this.FIBType_A == 3) {
            console.log(_this.AnswerBox.name, _this.AnswerBox1.name);
            if (_this.AnswerBox.name == _this.XArray[_this.PartAQnCnt] && _this.AnswerBox1.name == _this.YArray[_this.PartAQnCnt]) {
                console.log("initial answer is correct");
                _this.noofAttempts++;
                telInitializerbbpp.tele_saveAssessment(_this.questionid, "yes", _this.AnsTimerCount, _this.noofAttempts, _this.sceneCount);
    ...
    partBValidation2: function () {
        _this.Question_flag = 3;
        console.log(_this.FIBType_B);
        if (_this.FIBType_B == 1) {
            console.log("_this.FIBType" + _this.ZArray_PartB[_this.PartBQnCnt], Number("" + var_selectedAns1 + var_selectedAns2));
            console.log(_this.AnswerBox.name);
            if (_this.AnswerBox.name == _this.ZArray_PartB[_this.PartBQnCnt]) {
                console.log("FIBType 1 answer is correct");
                _this.noofAttempts++;
                telInitializerbbpp.tele_saveAssessment(_this.questionid, "yes", _this.AnsTimerCount, _this.noofAttempts, _this.sceneCount);
        ...
        if (_this.FIBType_B == 2) {
            console.log("_this.FIBType" + _this.FIBType_B, _this.XArray_PartB[_this.PartBQnCnt], _this.AnswerBox.name);
            if (_this.AnswerBox.name == _this.XArray_PartB[_this.PartBQnCnt]) {
                console.log("initial answer is correct");
                _this.noofAttempts++;
                telInitializerbbpp.tele_saveAssessment(_this.questionid, "yes", _this.AnsTimerCount, _this.noofAttempts, _this.sceneCount);
        ...
        if (_this.FIBType_B == 3) {
            console.log("ansBox1 name" + _this.XArray_PartB[_this.PartBQnCnt] + "ansbox2 name" + _this.ZArray_PartB[_this.PartBQnCnt], _this.YArray_PartB[_this.PartBQnCnt])
            console.log(_this.AnswerBox.name, _this.AnswerBox1.name);

            if (_this.AnswerBox.name == _this.XArray_PartB[_this.PartBQnCnt] && _this.AnswerBox1.name == _this.ZArray_PartB[_this.PartBQnCnt]) {
                console.log("initial answer is correct");
                _this.noofAttempts++;
                telInitializerbbpp.tele_saveAssessment(_this.questionid, "yes", _this.AnsTimerCount, _this.noofAttempts, _this.sceneCount);
    ...
    PartA_MCQ: function () {
        console.log('Part A FIB................................')
        _this.FIBTypeArray = [1, 2, 3];//1,2,3
        _this.FIBTypeArray = _this.shuffle(_this.FIBTypeArray);
        _this.QuestionBox();
        _this.displayFIBQn(_this.FIBTypeArray[_this.FIBTypeArrayCount_A]);
        _this.FIBTypeArrayCount_A++;
    ...
    displayFIBQn: function (target) {
        ...
        if (target == 2) {
            ...
            var equal = _this.add.text(55, 24, '=');//_this.SignArray[_this.count1]
            _this.applyingStyle(equal);
            var x = _this.add.text(170, 22, _this.YArray[_this.PartAQnCnt]);//
            _this.applyingStyle(x);
    ...
    wrongbtnClicked: function (target) {
        ...
        _this.selectedAns2 = '';
        // _this.AnswerBox.removeChild(_this.enterTxt);
        console.log(_this.FIBType_A, _this.FIBType_B)
        if (_this.FIBType_A == 3 || _this.FIBType_B == 3) {
        ...
        // Number("" +var_selectedAns1+var_selectedAns2) = 0;
    },
    ...
    CallingNextQuestion: function () {
        ...
        if (_this.QuestionArray[_this.count1] == 2) {
            _this.PartBQnCnt++;
            _this.PartB_initialEvaluation = 1;
            _this.PartB_secondEvaluation = 0;
            _this.FIBType_B = 0;
    ...
    numClicked: function (target) {
        ...
        if (_this.commonPart == 1) {
            ...
            _this.AnswerBox.name = Number("" + _this.selectedAns1 + _this.selectedAns2);
        }
        else if (_this.PartA_secondEvaluation == 1) {
            _this.AnswerBox.frame = 0;
            console.log(Number("" + _this.selectedAns1 + _this.selectedAns2));
            if (_this.FIBType_A == 3) {
                ...
                if (_this.secondBox == true && _this.FisrstBox == false) {
                    ...
                    _this.AnswerBox1.name = Number("" + _this.selectedAns1 + _this.selectedAns2);
            ...
            else if (_this.FIBType_A == 1 || _this.FIBType_A == 2) {
                _this.enterTxt.visible = false;
                _this.AnswerBox.removeChild(_this.enterTxt);
            ...
            else if (_this.FIBType_B == 1 || _this.FIBType_B == 2) {
                _this.enterTxt.visible = false;
                _this.AnswerBox.removeChild(_this.enterTxt);
                console.log("infbpart");
                if (Number('' + var_selectedAns1) == 0 && ('' + var_selectedAns2) < 10) {
    ...
    pot1Clicked: function () {
        console.log(_this.ZArray_PartB[_this.PartBQnCnt] + "pot1clicked")
        let col = 0;
        let row = 0;
        let i = 0;
        ...
        _this.loope.start();
        _this.loope.loop(500, () => {
            console.log(_this.BigTankBlueFishGroup_PartB.length, +"length" + _this.pot1FishGrp.length)
    ...
    pot2Clicked: function () {
        console.log(_this.ZArray_PartB[_this.PartBQnCnt] + "pot2clicked")
        let col = 0;
        let row = 0;
        let i = 0;
        _this.pot1.inputEnabled = false;
        ...
        _this.loope.loop(575, () => {
            ...
            if (_this.BigTankBlueFishGroup_PartB.length > 0 && _this.pot2FishGrp.length != _this.ZArray_PartB[_this.PartBQnCnt]) {
                ...
                console.log("loop stoped in else");
                _this.loope.stop();
                _this.bubbleSound.play();
                _this.pot1.inputEnabled = true;
                _this.pot2.inputEnabled = true;
    ...
    pot3Clicked: function () {
        console.log(_this.ZArray_PartB[_this.PartBQnCnt], _this.pot3FishGrp.length + "pot3clicked")
        let col = 0;
        let row = 0;
        let i = 0;
        _this.pot1.inputEnabled = false;
    ...
    pot4Clicked: function () {
        console.log(_this.ZArray_PartB[_this.PartBQnCnt] + "pot4clicked")
        let col = 0;
        let row = 0;
        let i = 0;
        _this.pot1.inputEnabled = false;
    ...
    pot5Clicked: function () {
        console.log(_this.ZArray_PartB[_this.PartBQnCnt] + "pot5clicked")
        let col = 0;
        let row = 0;
        let i = 0;
    ...
    PartB_MCQ: function () {
        console.log('Part B FIB................................')
        _this.FIBTypeArray = [1, 2, 3];//1,2,3
        _this.FIBTypeArray = _this.shuffle(_this.FIBTypeArray);
        _this.QuestionBox_PartB();
        _this.displayFIBQn_B(_this.FIBTypeArray[_this.FIBTypeArrayCount_B]);
        _this.FIBTypeArrayCount_B++;

        _this.addNumberPad();
    },

    displayFIBQn_B: function (target) {
        console.log(target);
        _this.PartB_secondEvaluation = 1;
        if (target == 1) {
            _this.FIBType_B = 1;
            console.log(_this.FIBType_B);
            var a = _this.add.text(30, 22, 'b');//_this.ValueXArray[_this.count1]
            _this.applyingStyle(a);
            a.fill = "#FF0000";
            var equal = _this.add.text(55, 24, '=');//_this.SignArray[_this.count1]
            _this.applyingStyle(equal);
            var x = _this.add.text(80, 22, _this.XArray_PartB[_this.PartBQnCnt]);//
            _this.applyingStyle(x);
            var minus = _this.add.text(120, 20, '/');
            _this.applyingStyle(minus);
            _this.AnswerBox = _this.add.image(150, 10, 'glowingTxtBox');
        ...
        if (target == 2) {
            ...
            var equal = _this.add.text(55, 24, '=');//_this.SignArray[_this.count1]
            _this.applyingStyle(equal);
            var x = _this.add.text(170, 22, _this.ZArray_PartB[_this.PartBQnCnt]);//
            _this.applyingStyle(x);
            var minus = _this.add.text(145, 20, '/');
            _this.applyingStyle(minus);
            _this.AnswerBox = _this.add.image(80, 10, 'glowingTxtBox');
        ...
        if (target == 3) {
            ...
            var a = _this.add.text(20, 20, 'b');//_this.ValueXArray[_this.count1]
            _this.applyingStyle(a);
            a.fill = "#FF0000";
            var equal = _this.add.text(40, 22, '=');//_this.SignArray[_this.count1]
            _this.applyingStyle(equal);
    ...
    VoiceNote1Fn: function () {
        ...
        _this.VoiceNote1src.setAttribute("src", window.baseUrl + "questionSounds/ALM-02-FIB-G6/" +
            _this.languageSelected + "/ALM-02-FIB-G6A.mp3");
    ...
    VoiceNote2Fn: function () {
        ...
        _this.VoiceNote2src.setAttribute("src", window.baseUrl + "questionSounds/ALM-02-FIB-G6/" +
            _this.languageSelected + "/ALM-02-FIB-G6B.mp3");
    ...
    VoiceNote3Fn: function () {
        ...
        _this.VoiceNote3src.setAttribute("src", window.baseUrl + "questionSounds/ALM-02-FIB-G6/" +
            _this.languageSelected + "/ALM-02-FIB-G6C.mp3");
    ...
    VoiceNote4Fn: function () {
        ...
        _this.VoiceNote3src = document.createElement('source');
        _this.VoiceNote3src.setAttribute("src", window.baseUrl + "questionSounds/ALM-02-FIB-G6/" +
            _this.languageSelected + "/ALM-02-FIB-G6D.mp3");
        _this.VoiceNote3.appendChild(_this.VoiceNote3src);
        _this.VoiceNote3.play();
    },
    ...
    DemoVideo: function () {
        ...
        // _this.demoAudio1src.setAttribute("src", window.baseUrl+ "questionSounds/ALM-02-FIB-G6/" + _this.languageSelected + "/ALM-02-FIB-G6.mp3");
        // _this.demoAudio1.appendChild(_this.demoAudio1src);

        //* audio for demo2
        // _this.demoAudio2 = document.createElement('audio');
        // _this.demoAudio2src = document.createElement('source');
        // _this.demoAudio2src.setAttribute("src", window.baseUrl+ "questionSounds/ALM-02-FIB-G6/" + _this.languageSelected + "/DV1-ALM-02-FIB-G6.mp3");
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/ALM-02-FIB-G6/" +
            _this.languageSelected + "/ALM-02-FIB-G6A.mp3");
        ...
        _this.q2Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/ALM-02-FIB-G6/" +
            _this.languageSelected + "/ALM-02-FIB-G6B.mp3");
        ...
        _this.q3Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/ALM-02-FIB-G6/" +
            _this.languageSelected + "/ALM-02-FIB-G6C.mp3");
        ...
        _this.q4Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/ALM-02-FIB-G6/" +
            _this.languageSelected + "/ALM-02-FIB-G6D.mp3");
    ...
    showDemoVideo: function () {
        _this.demoVideo_1 = _this.add.video('alm02_3');
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl + "assets/demoVideos/ALM-02-G6_3.mp4");
        ...
        _this.demoVideo_1.onComplete.add(function () {
            ...
            _this.demoVideo_2 = _this.add.video('alm02_1');
            _this.demoVideo_2.play(false);
            _this.demoVideo_2.changeSource(window.baseUrl + "assets/demoVideos/ALM-02-G6_1.mp4");  //* phaser needs this.to run in mobile
            ...
            _this.demoVideo_2.onComplete.add(function () {
                _this.demoVideo_3 = _this.add.video('alm02_2');
                _this.demoVideo_3.play(false);
                _this.demoVideo_3.changeSource(window.baseUrl + "assets/demoVideos/ALM-02-G6_2.mp4");  //* phaser needs this.to run in mobile
