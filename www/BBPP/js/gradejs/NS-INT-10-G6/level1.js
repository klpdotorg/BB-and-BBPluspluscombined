Game.NS_INT_10_G6level1 = function () { };


Game.NS_INT_10_G6level1.prototype =
{
    ...
    create: function (game) {
        ...
        _this.square3 = _this.add.image(-200, -200, 'highlightBox');

        _this.square3.scale.setTo(0.8, 0.7);
        _this.square3.visibile = false;
        _this.square4 = _this.add.image(-200, -200, 'highlightBox');
    ...
    gotoaddingInteger: function () {
        ...
        _this.Txt2 = _this.add.text(120, 33, "(+" + _this.element2 + ")", { fontSize: '30px', font: 'Akzidenz-Grotesk BQ' });
        ...
        _this.minus_sign = _this.add.text(94, 33, "-", { fontSize: '30px', font: "Akzidenz-Grotesk BQ" });
    ...
    ShowNullifyAction: function () {
        var dragMinus = _this.add.sprite(45, _this.spoty_rectaglebox2, 'minus');
        var dragPlus = _this.add.sprite(45, _this.spoty_rectaglebox1, 'plus');
        dragPlus.bringToTop();
        ...
        dragMinusDragAction.onComplete.add(function () {
            dragMinus.destroy();
    ...
    checkoverlap_plus_placing: function (target) {
        //* Check if first rectangle box is filled with required counters &
        //* counter has been dragged and left overlapping to the second box
        ...
        //* else if the counter is left overlapping rectangle box1 and 
        //* rectangle box does not have any counters placed 

        else if (_this.checkOverlap(target, _this.rectangleBox1) && _this.obj_group2.length < 1) {
    ...
    checkoverlap_plus_placing1: function (target) {
        if (_this.first_evaluation == 0) {
            if ((_this.vy == _this.spoty_rectaglebox2 && _this.obj_group2.length <= _this.element2) ||
                (_this.vy == _this.spoty_rectaglebox1 && _this.obj_group1.length <= _this.element1)) {
                target.x = _this.vx;
                target.y = _this.vy;
                return;
            }
    ...
    starActions: function (starCount) {
        _this.score++;
        // _this.userHasPlayed = 1;
        // _this.game_id='NS_INT_10_G6';
        // _this.timeinMinutes = _this.minutes;
        // _this.timeinSeconds = _this.seconds;
        // _this.grade = "6";
        // _this.gradeTopics = "Integers";
         _this.microConcepts = "Number Systems";
        // console.log( _this.score," score increasing !!!!!!")
        console.log('the count1 is: ' + _this.count1);

        starAnim = _this.starsGroup.getChildAt(starCount);
