Game.NSF_DFF_G7level1 = function () { };


Game.NSF_DFF_G7level1.prototype =
{
    init: function (param, score) {
        ...
        telInitializerbbpp.gameIdInit("NSF_DFF_G7", gradeSelected);// first Tele call
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", window.baseUrl + "questionSounds/NSF-DFF-G7/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    Initial_randomizing: function () {
        ...
        // ●	Both the  terms will be any fractions ( proper or improper). 
        // ●	a/b ÷ c /d ; where ‘ a’ , ’b’,’c’  lies between 2 to 10 
        // ●	Also the value of ‘a’ and ‘d’ such that a *d <=30 and the value of ‘b’ and ‘c’ such that  b* c <= 30 ; 
        // ●	Some examples:
        // ○	½ ÷  ¾ = 4/6
        // ○	⅗ ÷ 6/7 = 21/30 
        // ○	7/5 ÷  3/2 = 14/15
        //a/b ÷ c/d => a = 2-10, b= 2-10, c= 2-10, d= 2-10
        ...
        for (let i = 0; i < 6; i++) {
            _this.denominatorB = Math.floor(Math.random() * (9) + 2); //generate 2 to 10
            _this.numeratorA = Math.floor(Math.random() * (9) + 2); //generate 2 to 10

            _this.numeratorC = Math.floor(Math.random() * (9) + 2); //generate 2 to 10
            _this.denominatorD = Math.floor(Math.random() * (9) + 2);// generate 2 to 15

            while ((_this.numeratorA * _this.denominatorD > 30) || (_this.denominatorB * _this.numeratorC > 30) || (_this.denominatorB == _this.numeratorA) || (_this.denominatorD == _this.numeratorC) || (_this.denominatorD * _this.denominatorB > 30)) {// || (_this.denominatorD == _this.denominatorB)
                _this.denominatorB = Math.floor(Math.random() * (9) + 2); //generate 2 to 10
                _this.numeratorA = Math.floor(Math.random() * (9) + 2); //generate 2 to 10
            ...
            lcm = _this.getLcm(_this.denominatorB, _this.denominatorD);//12
        ...
        // for (var i = 0; i < 6; i++) {
        //     valuesCombinationsNum.push(_this.aArr[i] * _this.dArr[i]);//lcm(nume of first num and denom of sec num)//5,3
        // }
        // for (var i = 0; i < 6; i++) {
        //     valuesCombinationsDenom.push(_this.bArr[i] * _this.cArr[i]);//lcm(nume of secnd num and denom of first num)
        // }

        for (var i = 0; i < 6; i++) {
            valuesCombinationsNum.push(_this.aArr[i] * (_this.lcm[i] / _this.bArr[i]));//lcm(nume of first num and denom of sec num)//5,3//_this.aArr[i] * _this.dArr[i]
        }
        for (var i = 0; i < 6; i++) {
            valuesCombinationsDenom.push(_this.cArr[i] * (_this.lcm[i] / _this.dArr[i]));//lcm(nume of secnd num and denom of first num)
        }
    ...
    showInitialScreen: function () {
        ...
        _this.AnsBox2.scale.setTo(3.2, 0.8);
        ...
        if (_this.aArr[_this.count1] >= 10)
            _this.n1 = _this.add.text(6, 5, _this.aArr[_this.count1])
        else
            _this.n1 = _this.add.text(14, 5, _this.aArr[_this.count1])

        _this.n1.scale.setTo(0.8)

        _this.box1Display.addChild(_this.n1)
        _this.applyingStyle(_this.n1);
        ...
        if (_this.bArr[_this.count1] >= 10)
            _this.d1 = _this.add.text(8, 30, _this.bArr[_this.count1])
        else
            _this.d1 = _this.add.text(14, 30, _this.bArr[_this.count1])

        _this.box1Display.addChild(_this.d1)
        _this.applyingStyle(_this.d1);
        _this.d1.scale.setTo(0.8)
        _this.d1.fill = '#FF0000';
    ...
    rightbtnClicked: function () {
        ...
        if (_this.yellowBox2.visible == true) {
            ...
            if (_this.ans2Grp.children.length == _this.aArr[_this.count1] && _this.validateRods(_this.ans2Grp, _this.aArr[_this.count1])) {
                ...
                if (_this.dArr[_this.count1] >= 10)
                    _this.d22 = _this.add.text(6, 30, _this.dArr[_this.count1])
                else
                    _this.d22 = _this.add.text(14, 30, _this.dArr[_this.count1])
    ...
    evaluateCubesGrp: function () {
        console.log("evaluateCubesGrp");
        _this.clickSound.play();
        _this.rightbtn.inputEnabled = false;
        _this.rightbtn.frame = 1;
        if ((_this.ans1Grpcpys.length == _this.ans4Grpcpys.length) && (_this.ans2Grpcpys.length == valuesCombinationsNum[_this.count1]) && (_this.ans3Grpcpys.length == valuesCombinationsDenom[_this.count1])) {// && (_this.ans1Grpcpys.length == _this.bArr[_this.count1])
            _this.ans1Grpcpy.destroy();
            _this.ans2Grpcpy.destroy();
            _this.ans3Grpcpy.destroy();
            _this.ans4Grpcpy.destroy();
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DFF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d1.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //* if any number is whole number then first change whole number in to fraction
        _this.demoAudio2 = document.createElement('audio');
        _this.demoAudio2src = document.createElement('source');
        _this.demoAudio2src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DFF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d2.mp3");
        ...
        _this.demoAudio3src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DFF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d3.mp3");
        ...
        _this.demoAudio4src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DFF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d4.mp3");
        ...
        _this.demoAudio5src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DFF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d5.mp3");
        ...
        _this.demoAudio6src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DFF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d6.mp3");
        ...
        _this.demoAudio7src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DFF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d7.mp3");
        ...
        _this.demoAudio8src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DFF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d8.mp3");
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/NSF-DFF-G7/" +
        ...
        _this.q2Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/NSF-DFF-G7/" +
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1 = _this.add.video('nsfdff');
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl + "assets/demoVideos/NSF-DFF-G7.mp4");
