Game.NS_INT_12_G6level1=function(){};


Game.NS_INT_12_G6level1.prototype =
{
    ...
    init:function(game)
    {
        ...
        telInitializerbbpp.gameIdInit("NS_INT_12_G6", gradeSelected);
	...
	create:function(game)
    {
        ...
        _this.pluscount_box1=0;//counting to match first element
        _this.count_box2=0;
        ...
        _this.allQuestion=[1,2,3,4,5];
        _this.allQuestion_count=0;
    ...
    tickbtn_Clicked_and_evaluation:function()
    {
        ...
        {
            if(_this.object_sign_box1[_this.obj_group1.getChildAt(i).name]!=1 && _this.object_sign_box1[_this.obj_group1.getChildAt(i).name]!=0)
            {
                j=0;
                break;
            }
        ...
        if(j==1)
        {
            for(var i=0;i<_this.obj_group2.length;i++)
            {
                if(_this.object_sign_box2[_this.obj_group2.getChildAt(i).name]!=1 && _this.object_sign_box2[_this.obj_group2.getChildAt(i).name]!=0)
                {
                    j=0;
                    break;
                }
        ...
        if(j==1)
        {
           ...
           // _this.first_evaluation=1;
            ...
            //_this.obj_group1.getChildAt(i).input.useHandCursor = true;
            }
            ...
            _this.time.events.add(2000,function()
            {
                ...
                _this.flipbtn.input.useHandCursor = true;
                _this.flipbtn.events.onInputDown.add(_this.flipbtnClicked);
                _this.flipbtn.frame=1;
                if(_this.allQuestion[_this.allQuestion_count]==1||_this.allQuestion[_this.allQuestion_count]==2||_this.allQuestion[_this.allQuestion_count]==3){
        ...
        else
        {
            ...
            if(_this.allQuestion[_this.allQuestion_count]==1||_this.allQuestion[_this.allQuestion_count]==3||_this.allQuestion[_this.allQuestion_count]==4||_this.allQuestion[_this.allQuestion_count]==5){
                _this.enablingSign();
            }
    
            if(_this.allQuestion[_this.allQuestion_count]==2){
                _this.enablingSign_plus(); 
            }            
            _this.flipbtn.frame=0;
    ...
    {
         var dragPlus = _this.add.sprite(181,85,'minus');
    ...
    flipbtnClicked:function()
    {
        _this.clickSound.play();
            ...
            for(_this.index=0;_this.index<=15;_this.index++)
            {
                if(_this.object_present_box2[_this.index]==1)
                {
                    if(_this.object_sign_box2[_this.index]==1)
                    {
                        for(i=0;i<_this.obj_group2.length;i++)
                        {
                            console.log('here');
                            if(Number(_this.obj_group2.getChildAt(i).name)==_this.index)
                            {                                
                                    _this.object_sign_box2[_this.index]=0;
                                    _this.obj_group2.getChildAt(i).destroy();                           
                                    _this.img=_this.add.sprite(_this.array_box_x[_this.index],_this.spoty_rectaglebox2,'minus');
                                    _this.img.frame=0;
                                    _this.img.name=String(_this.index);
                                    _this.img.inputEnabled=true;
                                    _this.img.input.useHandCursor = true;
                                    if(_this.allQuestion[_this.allQuestion_count]==4||_this.allQuestion[_this.allQuestion_count]==5){
                                        _this.img.events.onInputDown.add(_this.plusClicked1,_this);
                                        
                                    }
                                    _this.obj_group2.add(_this.img);                                                                                   
                                    break;
                    ...
                    else
                    {
                        for(i=0;i<_this.obj_group2.length;i++)
                        {
                            if(Number(_this.obj_group2.getChildAt(i).name)==_this.index)
                            {
                                    ...
                                    _this.object_sign_box2[_this.index]=1;
                                    _this.obj_group2.getChildAt(i).destroy();                           
                                    _this.img=_this.add.sprite(_this.array_box_x[_this.index],_this.spoty_rectaglebox2,'plus');
                                    _this.img.frame=0;
                                    _this.img.name=String(_this.index);
                                    _this.img.inputEnabled=true;
                                    _this.img.input.useHandCursor = true;
    ...
    Questions: function(){
        ...
        _this.Question_AnswerBox.frame=1;
        switch(_this.allQuestion[_this.allQuestion_count])
        {
            

            case 1: console.log("inside fist qn");
                    //_this.randomizing_elements();
                    _this.randomizing_elements1();   
                    _this.gotoaddingInteger();
                    break;
            case 2: 
                    console.log("inside second qn");
                    //_this.randomizing_elements();
                    _this.randomizing_elements1();   
                    _this.gotoaddingInteger();
                    break;
            case 3: console.log("inside third qn");
                    //_this.randomizing_elements();
                    _this.randomizing_elements1();   
                    _this.gotoaddingInteger();
                    break;
            case 4: console.log("inside fourth qn");
                    //_this.randomizing_elements()
                    _this.randomizing_elements1(); 
                    _this.gotoaddingInteger();  
                    break;
            case 5: console.log("inside fifth qn");
                    //_this.randomizing_elements();
                    _this.a=_this.box1Array[_this.flag1];
                    _this.b=_this.a;
                    _this.gotoaddingInteger();
                    break;
        }
    ...
    gotoaddingInteger:function(a,b)
    {
        _this.element1=_this.a;//_this.box1Array[_this.flag1];
        _this.element2=_this.b;//_this.box2Array[_this.flag2];

        console.log(_this.element1);
        console.log(_this.element2);

        _this.rightbtn_is_Clicked=false;
        if (this.count1 == 0)  _this.Ask_Question();   //* audio Q onlt for first question
            
        if(_this.allQuestion[_this.allQuestion_count]==1||_this.allQuestion[_this.allQuestion_count]==3){
            
            _this.sign1="-";
            _this.sign2="+";
            _this.Txt1 = _this.add.text(27,33,_this.sign1 +_this.element1,{ fontSize: '30px',font:'Akzidenz-Grotesk BQ'});
            _this.Txt2 = _this.add.text(122,33,"("+_this.sign2+_this.element2+")",{ fontSize: '30px',font:'Akzidenz-Grotesk BQ'});
        }
        ...
        _this.minus_sign=_this.add.text(90,33,"-", { fontSize: '30px', font: "Akzidenz-Grotesk BQ"});

        _this.equalTo=_this.add.text(207,33,"=",{ fontSize: '30px', font: "Akzidenz-Grotesk BQ"});
        _this.equalTo.fill = '#000000';
        _this.minus_sign.fill = '#FF0000'
        ...
        _this.Question_AnswerBox.addChild(_this.Txt2);
         _this.Question_AnswerBox.addChild(_this.minus_sign);
        ...
        if (_this.count1 == 0)  _this.ShowDragAction();
    },
    ...
    randomizing_elements1:function()
    {
        
        console.log(_this.box1Array[_this.flag1]);
        //console.log(_this.box2Array[_this.flag1]);
        
        if(_this.allQuestion[_this.allQuestion_count]==1||_this.allQuestion[_this.allQuestion_count]==2){
            _this.a = _this.box1Array[_this.flag1];
            ...
            _this.b = Math.floor(Math.random()*(_this.a-1-1+1))+1;
        }
        
        else if(_this.allQuestion[_this.allQuestion_count]==3||_this.allQuestion[_this.allQuestion_count]==4){
            _this.b= _this.box1Array[_this.flag1];
            ...
            _this.a=Math.floor(Math.random()*(_this.b-1-1+1))+1;
        }
    ...
    ShowNullifyAction:function()
    {
         var dragPlus = _this.add.sprite(45,_this.spoty_rectaglebox2,'plus');
         var dragMinus  = _this.add.sprite(45,_this.spoty_rectaglebox1,'minus');
         dragPlus.bringToTop();
         dragMinus.bringToTop();
         
         dragPlusDragAction = _this.add.tween(dragPlus);
         dragPlus.bringToTop();
         dragPlusDragAction.to({x: 45, y: _this.spoty_rectaglebox1 }, 1250, 'Quart', false, 0);
         dragPlusDragAction.onComplete.add(function() 
         {
    ...
    numClicked:function(target)
    {
                ...
                //_this.enterTxt.text = ""+_this.selectedAns1+_this.selectedAns2+_this.selectedAns3;
    ...
    evaluation1:function()
    {
        console.log(_this.element1);
        console.log(_this.element2);
        if(_this.allQuestion[_this.allQuestion_count]==1||_this.allQuestion[_this.allQuestion_count]==3||_this.allQuestion[_this.allQuestion_count]==4){
            _this.element1=Number("-"+_this.element1);
        }
        if(_this.allQuestion[_this.allQuestion_count]==2||_this.allQuestion[_this.allQuestion_count]==4){
            _this.element2=Number("-"+_this.element2);
        }
        
        if(_this.element1-_this.element2<0)
        {
            if(_this.selectedAns1=='-')
            {
                if(Number(''+_this.selectedAns2+_this.selectedAns3)==(_this.element2-_this.element1))
                {console.log("hi");                   
                    return 1;
                }
                else
        ...
        else if((_this.element1)-(_this.element2)==0)
        {
            if(_this.enterTxt.text == "")
                {
                    return 0;
                }
                else if(_this.selectedAns1 == "+")
                {
                    return 0;
                }
                else if(_this.selectedAns1 == "-")
                ...
                else if(Number(_this.selectedAns2+_this.selectedAns3)==0)
                {
                    return 1;
                }
    ...
    evaluation2:function()
    {
        ...
        if(((_this.element1)-(_this.element2))<0)
        {
            ...
            if(_this.obj_group1.length==0 &&_this.obj_group2.length==((_this.element2)-(_this.element1)))
            {
                for(_this.j=0;(_this.j<_this.obj_group2.length);_this.j++)
                {
                    if(_this.object_sign_box2[Number(_this.obj_group2.getChildAt(_this.j).name)]==0)
                        _this.ans+=1;
                ...
                if(_this.ans==(_this.element2)-(_this.element1))
                {
                    return 1;
                }
                else
        ...
        {        
            if(_this.obj_group1.length==0 &&_this.obj_group2.length==((_this.element1)-(_this.element2)))
            {console.log("check sign")
                for(_this.j=0;(_this.j<_this.obj_group1.length);_this.j++)
                {
                    if(_this.object_sign_box1[Number(_this.obj_group1.getChildAt(_this.j).name)]==1)
                    {
                        console.log("check sign");
                        _this.ans+=1;                        
                    }    

                    else if(_this.object_sign_box2[Number(_this.obj_group1.getChildAt(_this.j).name)]==1)
                    {console.log("check sign");
                        _this.ans+=1;
                ...
                if(_this.ans==((_this.element1)-(_this.element2)))
                {
                    return 1;
                }
                else
    ...
    celebration:function()
    {
        console.log(_this.element1);
        console.log(_this.element2);
        console.log(_this.element1-_this.element2);
        ...
        if(_this.element1-_this.element2 <0){
            ...
            for(_this.j=0;_this.j<=_this.a-1;_this.j++)
            {
                console.log("hi");
            ...
            for(_this.j=0;_this.j<=_this.b-1;_this.j++)
            {
    ...
    celebration_2:function()
    {
        ...
        else if(_this.allQuestion[_this.allQuestion_count]!=4)
        {

            console.log(_this.obj_group2.length);
            _this.obj_group1.removeAll();
            _this.obj_group2.removeAll();
        ...
        if(_this.allQuestion[_this.allQuestion_count]==4){
            _this.obj_group2.removeAll();
            for(_this.j=0;_this.j<=(_this.element1-_this.element2)-1;_this.j++)
            {
                _this.plus_anm=_this.add.sprite(_this.array_box_x[_this.j],_this.spoty_rectaglebox2,'plus_anm');
                _this.plus_anm.animations.add('plus_anm');
                _this.plus_anm.frame = 0;
    ...
    rightbtnClicked:function()
    {
        ...
        if(_this.evaluation1() )
        {
            ...
            if(_this.allQuestion[_this.allQuestion_count]==1||_this.allQuestion[_this.allQuestion_count]==3||_this.allQuestion[_this.allQuestion_count]==5){
                _this.celebration();
            }
            
            else if(_this.allQuestion[_this.allQuestion_count]==2||_this.allQuestion[_this.allQuestion_count]==4){
                _this.celebration_2();
            }
            ...
            {
                //_this.anmGroup.destroy();
                //_this.wrongbtnClicked();//delete text 
                _this.square1.frame=0;
                _this.square2.frame=0;
            });  
            ...
            if(_this.count1 < 5)
            {
                ...
                _this.time.events.add(5000,function()
                {
                    ...
                    _this.allQuestion_count++;
                   
                   console.log(_this.allQuestion_count);
                   
                   if(_this.allQuestion_count==5){
                        _this.allQuestion=[1,2,3,4];
                        _this.shuffle(_this.allQuestion);
                        _this.allQuestion_count=0;
                        }
...
//                _this.time.events.add(5000,function(){ window.parent.location.reload();});
        ...
        else
        {
            ...
            _this.flipbtn.inputEnabled=false;
            _this.element1=_this.a;
            _this.element2=_this.b
            _this.wrongbtnClicked();
            _this.wrongbtn.events.onInputDown.add(_this.wrongbtnClicked,_this);
            _this.rightbtn.events.onInputDown.add(_this.rightbtnClicked,_this); 
            _this.rightbtn_is_Clicked=false;
    ...
    enablingSign_plus:function()
    {   
           _this.plus2.inputEnabled = true;
           _this.plus2.input.useHandCursor = true;
           _this.plus2.events.onInputDown.add(_this.plusClicked,_this.minus2);                    
    },
    ...
    {          
        if(_this.checkOverlap(target, _this.rectangleBox2) && _this.sign2=="+"&&_this.obj_group1.length >= _this.element1)
        {    
        ...
        else if(_this.checkOverlap(target, _this.rectangleBox1) && _this.sign1=="+"){//&&_this.obj_group1.length < _this.element1){
    ...
    {          
        if(_this.checkOverlap(target, _this.rectangleBox2) && _this.obj_group1.length >= _this.element1 &&_this.sign2=="-")
        {    
            for(_this.i=0;_this.i<=15&&_this.object_present_box2[_this.i]!=0;_this.i++);

            if(_this.i!=16)
            {
                _this.Newplus = _this.add.sprite(_this.array_box_x[_this.i], _this.spoty_rectaglebox2,'minus');
                _this.Newplus.frame=0;
        ...
        //else if(_this.obj_group1.length>=_this.element1)
        //{
        else if(_this.checkOverlap(target, _this.rectangleBox1) && _this.sign1=="-" )//&&_this.obj_group1.length < _this.element1)
        {
            if(_this.obj_group2.length==0){
                ...
                if(_this.i!=16)
                {
                    _this.Newplus =_this.add.sprite(_this.array_box_x[_this.i], _this.spoty_rectaglebox1,'minus');
                    _this.Newplus.frame=0;
                    ...
                    if(_this.checkOverlap(_this.obj_group1.getChildAt(_this.index),target))
                    {
                        if(_this.object_sign_box1[Number(_this.obj_group1.getChildAt(_this.index).name)]!=_this.object_sign_box2[Number(target.name)])
                        {
                            ...
                            _this.time.events.add(550,function()
                            {
                                ...
                                {
                                    //if(_this.flipbtn.frame==0)
                                    //{console.log(_this.flipbtn.frame);
