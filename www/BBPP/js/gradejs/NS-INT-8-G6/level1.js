...
Game.NS_INT_8_G6level1=function(){};


Game.NS_INT_8_G6level1.prototype =
{
    ...
    celebration:function()
    {
        if(_this.element1-_this.element2<0)
        {
            ...
            {
                _this.minus_anm=_this.add.sprite(_this.array_box_x[_this.j],_this.spoty_rectaglebox2,'plus_anm');
                _this.minus_anm.animations.add('plus_anm');
