Game.NSF_UNLSB_G7level1 = function () { };


Game.NSF_UNLSB_G7level1.prototype =
{
    init: function (param, score) {
        ...
        _this.Ask_Question1 = _this.createAudio("NSF_UNLSB_G7_a1");
        _this.Ask_Question2 = _this.createAudio("NSF_UNLSB_G7_a2");
        // _this.Ask_Question3 = _this.createAudio("V3");

        //edited for baseurl apk
        telInitializerbbpp.gameIdInit("NSF_UNLSB_G7", gradeSelected);// first Tele call
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", window.baseUrl + "questionSounds/NSF-UNLSB-G7/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    StoreArrayValues: function () {
        ...
        for (i = 0; i < 6; i++) {
            if (randarr[i] == 0) {
                ...
                min = denom11 + 1;
                max = Math.floor((30) / (lcm / denom11));
                num1 = Math.floor(Math.random() * (max - min + 1) + min)
                while (num1 % denom11 == 0)
                    num1 = Math.floor(Math.random() * (max - min + 1) + min)

                min = denom21 + 1;
                max2 = Math.floor((30) / (lcm / denom21))
                ...
                if (num2 * (lcm / denom21) == num1 * (lcm / denom11)) {
                    if (num2 > num1)
                        num2 -= 1;
                    else
                        num1 -= 1;
                ...
                while (denom11 == denom21 || (denomCom.includes(denom11 + "" + denom21) || denomCom.includes(denom21 + "" + denom1))) {
            ...
            if (num1 * (lcm / denom11) < num2 * (lcm / denom21)) {
            ...
            denomCom.push(denom21 + "" + denom11)

            da.push(denom11 + "" + denom21)

            valuesCombinationsNum.push(numer1[i] * (lcm / denom1[i]) - numer2[i] * (lcm / denom2[i]))
    ...
    showInitialScreen: function () {
        ...
        if (numer1[_this.count1] >= 10)
            _this.n11 = _this.add.text(7, 5, numer1[_this.count1])
        ...
        if (denom1[_this.count1] >= 10)
            _this.d11 = _this.add.text(7, 30, denom1[_this.count1])
        else
    ...
    makeansCpy: function () {
        ...
        _this.ansgrpCopyBorders(_this.ans1Grp, 313, 402);
        ...
        _this.ansgrpCopyBorders(_this.ans2Grp, 313, 402 - 20);
        ...
        _this.ansgrpCopyBorders(_this.ans3Grp, 313, 442);
        ...
        _this.ansgrpCopyBorders(_this.ans4Grp, 313, 462);
    ...
    showHandSymbol: function () {
        ...
        _this.hand = _this.add.sprite(380, 230, 'hand');
        ...
        _this.tween1.to({ x: 0, y: 196 }, 800, 'Linear', true, 0);
    ...
    makeDraggableCubeGrp: function () {
        ...
        // if (_this.ans1Grpcpys.length < _this.ans4Grpcpys.length) {
        ...
        // }
        // else if (_this.ans4Grpcpys.length < _this.ans1Grpcpys.length) {
    ...
    dragStopBorder: function (grp, x, y) {
        if (grp.length > 10 || grp.length > (grp.getChildAt(0).frame + 1)) {
            borderboxc = x;

            for (q = 0; q < grp.length - 1; q++) {
                if ((grp.getChildAt(q).frame != grp.getChildAt(q + 1).frame) || ((q + 1) % (grp.getChildAt(q).frame + 1) == 0 && _this.checkAllSameBoxes(grp))) {
                    _this.makeRectBox(grp.getChildAt(q).frame + 1, y, borderboxc);
                    borderboxc += (19 * (grp.getChildAt(q).frame + 1));
    ...
    dragStopgrp: function (target) {
        if ((_this.ans1Grpcpy.children.includes(target) || _this.ans2Grpcpy.children.includes(target)) && !_this.checkOverlap(target, _this.AnsBox2) && _this.checkOverlap(target, _this.AnsBox)) {
            ...
            _this.borderBox11.destroy();
            _this.borderBox11 = _this.add.group();
            _this.dragStopBorder(_this.ans1Grpcpys, 313, 402);

            _this.borderBox21.destroy();
            _this.borderBox21 = _this.add.group();
            _this.dragStopBorder(_this.ans2Grpcpys, 313, 402 - 20);
            ...
            _this.borderBox31.destroy();
            _this.borderBox31 = _this.add.group();
            _this.dragStopBorder(_this.ans3Grpcpys, 313, 462);

            _this.borderBox41.destroy();
            _this.borderBox41 = _this.add.group();
            _this.dragStopBorder(_this.ans4Grpcpys, 313, 442);
    ...
    reArrangeScreen: function () {
        ...
        // if (_this.count1 == 0)
        //     _this.Ask_Question2.play();
        _this.showfraction2Boxes(260, 190 - 5);
        _this.part1 = true;
        _this.rightbtn.destroy();
        _this.addNumberPad()
    ...
    makeupperRodsGGrp: function (x, y, z, t) {
        ...
        _this.ansgrpCopyBorders(_this.ans1Grpcpys, 313, 221);
        _this.ansgrpCopyBorders(_this.ans2Grpcpys, 313, 221 - 20);
        _this.ansgrpCopyBorders(_this.ans3Grpcpys, 313, 322 - 20);
        _this.ansgrpCopyBorders(_this.ans4Grpcpys, 313, 322);
    ...
    rightbtnClicked: function () {
        ...
        if (_this.yellowBox2.visible == true) {
            ...
            if (_this.AnswerBox.name == ans1 && _this.AnswerBox1.name == ans2) {
                ...
                if (_this.part1 == true) {
                    _this.displayBox3 = _this.makedisplayBox(260, 188);
                    _this.textBox.visible = true;
                    _this.disableInputs();
                    _this.showfraction2Boxes(260, 293)
                    ...
                    _this.displayBox4 = _this.makedisplayBox(260, 293);
    ...
    enableCubesDrag: function () {
        ...
        _this.finalBorderb = _this.add.group();
    ...
    dragStopRod: function (target) {
        ...
        if (_this.ans1Grpcpys.children.includes(target) || _this.ans4Grpcpys.children.includes(target)) {
            ...
            _this.finalBorderb.destroy();
            _this.finalBorderb = _this.add.group();
            if ((_this.finalAnsGrpDenom.length == 2 * valuesCombinationsDenom[_this.count1] && _this.finalAnsGrpDenom.length > 20) || (_this.finalAnsGrpDenom.length != valuesCombinations[_this.count1] && _this.finalAnsGrpDenom.length > 10 && (_this.ans1Grpcpys.length > 0 || _this.ans4Grpcpys.length > 0))) {
                if (_this.finalAnsGrpDenom.length > 10 || _this.finalAnsGrpDenom.length > (_this.finalAnsGrpDenom.getChildAt(0).frame + 1)) {
                    borderboxc = 313;
                    grplength = _this.finalAnsGrpDenom.length == 2 * valuesCombinationsDenom[_this.count1] ? _this.finalAnsGrpDenom.length / 2 : _this.finalAnsGrpDenom.length
                    for (q = 0; q < grplength - 1; q++) {
                        if ((_this.finalAnsGrpDenom.getChildAt(q).frame != _this.finalAnsGrpDenom.getChildAt(q + 1).frame) || ((q + 1) % (_this.finalAnsGrpDenom.getChildAt(q).frame + 1) == 0 && _this.checkAllSameBoxes(_this.finalAnsGrpDenom)) || (count == currFrame)) {
                            ...
                            _this.finalBorderb.addChild(_this.graphics);
                        }
                ...
                _this.world.bringToTop(_this.finalBorderb);
            }
        ...
        if (_this.finalAnsGrpDenom.length == 2 * valuesCombinationsDenom[_this.count1] && _this.ans1Grpcpys.length == 0 && _this.ans4Grpcpys.length == 0) {
            ...
            if (_this.ans2Grpcpys.length == 0 && _this.ans3Grpcpys.length == 0) {
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", window.baseUrl + "questionSounds/NSF-UNLSB-G7/" + _this.languageSelected + "/NSF_UNLSB_G7_d1.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //* Placed the cuisenaire rods for the second  number
        _this.demoAudio2 = document.createElement('audio');
        _this.demoAudio2src = document.createElement('source');
        _this.demoAudio2src.setAttribute("src", window.baseUrl + "questionSounds/NSF-UNLSB-G7/" + _this.languageSelected + "/NSF_UNLSB_G7_d2.mp3");
        ...
        _this.demoAudio3src.setAttribute("src", window.baseUrl + "questionSounds/NSF-UNLSB-G7/" + _this.languageSelected + "/NSF_UNLSB_G7_d3.mp3");
        ...
        _this.demoAudio4src.setAttribute("src", window.baseUrl + "questionSounds/NSF-UNLSB-G7/" + _this.languageSelected + "/NSF_UNLSB_G7_d4.mp3");
        ...
        _this.demoAudio5src.setAttribute("src", window.baseUrl + "questionSounds/NSF-UNLSB-G7/" + _this.languageSelected + "/NSF_UNLSB_G7_d5.mp3");
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/NSF-UNLSB-G7/" +
            _this.languageSelected + "/NSF_UNLSB_G7_a1.mp3");
    ...
    dA3: function () {
        _this.demoVideo_1.playbackRate = 1;  //* continue    
    },

    showDemoVideo: function () {

        _this.demoVideo_1 = _this.add.video('nsfunlsb');
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl + "assets/demoVideos/NSF-UNLSB-G7.mp4");
        ...
        _this.demoAudio2Timer = setTimeout(function ()   //* demoAudio2Timer js timer to play demoAudio2 after 9 seconds.
        {
            console.log("inside demoAudio2Timer.....")
            clearTimeout(_this.demoAudio2Timer);         //* clear the time once its used.
            _this.demoAudio2.play();
        }, 9000);

        _this.demoAudio3Timer = setTimeout(function ()    //* demoAudio3Timer js timer to play demoAudio3 after 12.6 seconds.
        {
            console.log("inside demoAudio3Timer.....")
        ...
        _this.demoAudio5Timer = setTimeout(function ()   //* demoAudio5Timer js timer to play demoAudio5 after 28 seconds.
        {
            console.log("inside demoAudio5Timer.....")
