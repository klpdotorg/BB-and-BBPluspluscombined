Game.NSF_DWF_G7level1 = function () { };


Game.NSF_DWF_G7level1.prototype =
{
    init: function (param, score) {
        ...
        telInitializerbbpp.gameIdInit("NSF_DWF_G7", gradeSelected);// first Tele call
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", window.baseUrl + "questionSounds/NSF-DWF-G7/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    StoreArrayValues: function () {
        ...
        for (i = 0; i < 6; i++) {
            ...
            if (randarr[i] == 0) {
                num1 = Math.floor(Math.random() * (3 - 2 + 1) + 2)
                denom21 = Math.floor(Math.random() * (9 - 2 + 1) + 2)
                min = denom21 + 1;
                num2 = Math.floor(Math.random() * (10 - min + 1) + min)
                ...
                while (denomCom.includes(num2 + "" + denom21) || num2 == 1 || denom21 == 1 || num2 == denom21 || num2 % denom21 == 0 || num1 * denom21 > 30 || denomCom.includes(num1)) {
                    num1 = Math.floor(Math.random() * (10 - 2 + 1) + 2)
                    denom21 = Math.floor(Math.random() * (9 - 2 + 1) + 2)
                    min = denom21 + 1;
                    num2 = Math.floor(Math.random() * (10 - min + 1) + min)
                    s1 = _this.simplestEquivalentFractionX(num2, denom21)
                ...
                num1 = Math.floor(Math.random() * (3 - 2 + 1) + 2)
                denom21 = Math.floor(Math.random() * (10 - 2 + 1) + 2)
                max = denom21 - 1;
            ...
            denomCom.push(num2 + "" + denom21)
            denomCom.push(num1)
            denom1.push(1);
            denom2.push(denom21);
            numer1.push(num1)
            numer2.push(num2)
            valuesCombinationsNum.push(num1 * denom21)
            valuesCombinationsDenom.push(num2)
    ...
    showInitialScreen: function () {
        ...
        if (numer1[_this.count1] >= 10)
            _this.n1 = _this.add.text(26 - 4, 30, numer1[_this.count1])
        else
            _this.n1 = _this.add.text(34 - 4, 30, numer1[_this.count1])
    ...
    showWholeBox: function () {
        ...
        _this.time.events.add(1500, function () {
            ...
            _this.tweenNumber = _this.add.tween(_this.n1);
            _this.tweenNumber.to({ x: _this.n1.x, y: 14 }, 500, 'Linear', true, 0);
            _this.tweenNumber.start();

            _this.tweenNumber.onComplete.add(function () {
                _this.hrLine(25 - 4, 47.5);
                _this.questionBox.addChild(_this.hrSign1);
                _this.AnswerBox = _this.add.image(268, 119, 'white-box');
    ...
    evaluateCubesGrp: function () {
        ...
        if ((_this.ans1Grpcpys.length == _this.ans4Grpcpys.length) && (_this.ans1Grpcpys.length == denom2[_this.count1])) {
            _this.ans1Grpcpy.destroy();
            _this.ans2Grpcpy.destroy();
            _this.ans3Grpcpy.destroy();
            _this.ans4Grpcpy.destroy();
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DWF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d1.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //* if any number is whole number then first change whole number in to fraction
        _this.demoAudio2 = document.createElement('audio');
        _this.demoAudio2src = document.createElement('source');
        _this.demoAudio2src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DWF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d2.mp3");
        ...
        _this.demoAudio3src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DWF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d3.mp3");
        ...
        _this.demoAudio4src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DWF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d4.mp3");
        ...
        _this.demoAudio5src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DWF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d5.mp3");
        ...
        _this.demoAudio6src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DWF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d6.mp3");
        ...
        _this.demoAudio7src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DWF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d7.mp3");
        ...
        _this.demoAudio8src.setAttribute("src", window.baseUrl + "questionSounds/NSF-DWF-G7/" + _this.languageSelected + "/NSF_DIV_01_G7_d8.mp3");
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/NSF-DWF-G7/" +
        ...
        _this.q2Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/NSF-DWF-G7/" +
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1 = _this.add.video('nsfdwf');
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl + "assets/demoVideos/NSF-DWF-G7.mp4");
