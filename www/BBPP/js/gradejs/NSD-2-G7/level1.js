Game.NSD_2_G7level1 = function () { };


Game.NSD_2_G7level1.prototype =
{
    init: function (param, score) {
        ...
        _this.Ask_Question1 = _this.createAudio("NSD_2_G7_a1");
        _this.Ask_Question2 = _this.createAudio("NSD_2_G7_a2");
        _this.Ask_Question3 = _this.createAudio("NSD_2_G7_a3");

        //edited for baseurl apk
        telInitializerbbpp.gameIdInit("NSD_2_G7", gradeSelected);// first Tele call
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", window.baseUrl + "questionSounds/NSD-2-G7/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    createOrgGreenGrp: function () {
        ...
        _this.or1.scale.setTo(0.5, 0.58)
        _this.or2.scale.setTo(0.5, 0.58);
        _this.or3.scale.setTo(0.5, 0.58);
        _this.or4.scale.setTo(0.5, 0.58);
    },
    ...
    dragStop: function (target) {
        ...
        if (_this.checkOverlap(target, _this.workSpace)) {
            ...
            if (target == _this.yellowStripecpy) {
                ...
                if (_this.lastXArr[0] == 0 || _this.lastXArr[1] == 0 || _this.yellowGrp.children.length > 0) {
                    ...
                    newBox = _this.add.sprite(_this.lastX + _this.yellowGrp.children.length * 15, 100 + _this.yellowGrp.children.length * 15, 'yellowBox')
                ...
                if (_this.lastXArr[0] == 0 || _this.lastXArr[1] == 0 || (_this.grayBox && _this.getEmptyIndex(_this.grayBoxEmty, 'orange') != undefined) || (_this.grayBox2 && _this.getEmptyIndex(_this.grayBox2Emty, 'orange') != undefined)) {
                    ...
                    y = idx % 10 != 0 ? idx % 10 * 22 + 6 * (Math.floor(idx % 10) - 1) : -6
                ...
                var arrBox;
                if (_this.yellowGrp.length <= 0 && (_this.lastXArr[0] == 0 || _this.lastXArr[1] == 0 || (_this.grayBox && _this.getEmptyIndex(_this.grayBoxEmty, 'green') != undefined) || (_this.grayBox2 && _this.getEmptyIndex(_this.grayBox2Emty, 'green') != undefined))) {
    ...
    reArrangeYellow: function () {
        ...
        _this.yellowGrp = _this.add.group();
        for (i = 0; i < x; i++) {
            newBox = _this.add.sprite(_this.lastX + i * 15, 100 + i * 15, 'yellowBox')
            _this.yellowGrp.add(newBox);
            newBox.scale.setTo(0.9, 1.05);
        }
    },
        ...
        if (mtyFound || (_this.yellowGrp.length > 0 && _this.yellowGrp.getChildAt(0).x != 257) || (_this.yellowGrp.length <= 0 && _this.grayBox.x != 257)) {
            ...
            if (Math.floor(multiplicandArr[_this.count1]) == 1) {
                ...
                for (i = 0; i < greenCn % 10; i++) {
                    ...
                    y = i % 10 != 0 ? i % 10 * 22 + 6 * (Math.floor(i % 10) - 1) : -6
                    if (greenCn < 10)
                        x -= 2;
    ...
    evaluateCubes: function () {
        ...
        if (_this.part1 == true)
            ...
            return anscount == multiplierArr[_this.count1] * 100;
    ...
    resizeType1: function () {
        ...
        _this.reSize2 = _this.time.create(false);
        timeC2 = 0;
        cn = 9
        _this.reSize2.loop(80, function () {
            _this.yellowGrp.children.forEach(element => {
                element.scale.setTo(cn / 10, cn / 10 + 0.016 * (10 - cn));
            });
            timeC2++;
            cn--;
    ...
    showGrayTSidebar: function () {
        ...
        _this.resizeg.to({ x: 0 - 118 + 10 * (9 - (Math.round((_this.firstGrp.getChildAt(_this.firstGrp.length - 1).x - _this.firstGrp.getChildAt(0).x) / 28))), y: 240 - 110 }, 800, 'Linear', true, 0);
    ...
    showyellowpartTransform() {
        ...
        if (_this.yellowGrp.length == 2) {
            _this.reSizey.loop(500, function () {
                ...
                _this.resizet1.to({ x: arrval[timeC] - 5, y: 100 }, 800, 'Linear', true, 0);
                _this.world.bringToTop(_this.yellowGrp)

                timeC++;
                if (timeC == _this.yellowGrp.length) {
                    _this.reSizey.stop();
                    _this.reSizey = null;
    ...
    showgraypartTransform: function () {
        ...
        for (k = 0; k < multiplierArr[_this.count1]; k++) {
            ...
            y = greenCn >= 10 ? 404 - Math.floor(greenCn / 10) * 16 : 404
            for (i = 0; i < greenCn % 10; i++) {
                x = 13.5 * i + initialVal[k] - 4
                newBox = _this.add.sprite(x, y, 'orangeBox');
                newBox.scale.setTo(0.57, 0.64)
                _this.arr.push(newBox);
                newBox.name = k + 1;
            ...
            if (_this.arr[q].key == 'orangeBox') {
                ...
                if (multiplierArr[_this.count1] >= 1 && _this.arr[q].name > 1 && _this.getEmptyIndex(_this.a1, 'orange') != undefined) {
                    if (_this.getEmptyIndex(_this.a1, 'orange') != undefined) {
                        ...
                        _this.a1[idx] = 0;
                        xp = 13.5 * (Math.floor(idx % 10)) + initialVal[0] - 4
                        yp = idx >= 10 ? 404 - 16 * Math.floor(idx / 10) : 404
                    ...
                    if (_this.getEmptyIndex(_this.a2, 'orange') != undefined) {
                        ...
                        _this.a2[idx] = 0;
                        xp = 13.5 * (Math.floor(idx % 10)) + initialVal[1] - 4
                        yp = idx >= 10 ? 404 - 16 * Math.floor(idx / 10) : 404
                        _this.resizet1 = _this.add.tween(_this.arr[q]);
                        _this.resizet1.to({ x: xp, y: yp }, 800, 'Linear', true, 0);
                        found = true;
                    ...
                    if (_this.getEmptyIndex(_this.a3, 'orange') != undefined) {
                        ...
                        _this.a3[idx] = 0;
                        xp = 13.5 * (Math.floor(idx % 10)) + initialVal[2] - 4
                        yp = idx >= 10 ? 404 - 16 * Math.floor(idx / 10) : 404
                        _this.resizet1 = _this.add.tween(_this.arr[q]);
                        _this.resizet1.to({ x: xp, y: yp }, 800, 'Linear', true, 0);
                        found = true;
            ...
            for (q = _this.arr.length - 1; q >= 0; q--) {
                if (_this.arr[q].key == 'greenBoxHr') {
                    ...
                    if (multiplierArr[_this.count1] >= 1 && _this.arr[q].name > 1 && _this.getEmptyIndex(_this.a1, 'green') != undefined) {
                        ...
                        y = idx > 0 ? 404 - idx * 16 : 404
                        found = true;

                        _this.resizet1 = _this.add.tween(_this.arr[q]);
                        _this.resizet1.to({ x: x + 3, y: y }, 800, 'Linear', true, 0);
                    }
        ...
        if ((Math.floor(multiplicandArr[_this.count1]) == 0 && multiplicandArr[_this.count1] > 0.85)) {
            _this.resizet1.onComplete.add(() => {
    ...
    makeGrayBoxes: function () {
        ...
        for (i = 0; i < greenCn; i++) {
            newBox = _this.add.sprite((i % 10) * 13.4 + yellowgrp.x - 3, yellowgrp.y - 8 + 125 + 19 - Math.floor(i / 10) * 15.6, 'grySmall');
            newBox.scale.setTo(0.55, 0.72)
            grp.addChild(newBox);
        }
        grp = _this.g2;
    ...
    showAnim1: function () {
        for (i = 0; i < _this.yellowGrp.children.length; i++) {
            ...
            yellowgrp.children.forEach(element => {
                _this.resizet1 = _this.add.tween(element);
                _this.resizet1.to({ y: element.y + 236 + 94 - 40 }, 1200, 'Linear', true, 0);
            });
    ...
    makeDraggableGrp: function (yellowgrp) {
        if (yellowgrp.children.length > 0) {
            ypos = yellowgrp.getChildAt(yellowgrp.children.length - 1).y - 27;
        } else ypos = 410;
        ...
        if (possibleGrp + currentGrp <= 100) {
            ...
            for (q = 0; q < _this.yellowGrp.children.length; q++) {
                ...
                for (i = 0; i < Math.floor(greenCn / 10); i++) {
                    x = -8;
                    y = yellowgrp.children.length > 0 ? yellowgrp.getChildAt(yellowgrp.children.length - 1).y - 27 : 410
                    newBox = _this.add.sprite(x, y, 'greenBoxHr');
                    yellowgrp.addChild(newBox);
                    newBox.scale.setTo(1, 0.97);
                }
                y = yellowgrp.children.length > 0 ? yellowgrp.getChildAt(yellowgrp.children.length - 1).y - 27 : 410;
                for (i = 0; i < greenCn % 10; i++) {
        ...
        for (m = 0; m < loopcount; m++) {
            ...
            for (q = 0; q < _this.yellowGrp.children.length; q++) {
                ...
                for (i = 0; i < Math.floor(greenCn / 10); i++) {
                    ...
                    y = yellowgrp.children.length > 0 ? yellowgrp.getChildAt(yellowgrp.children.length - 1).y - 27 : 410
                    newBox = _this.add.sprite(x, y, 'greenBoxHr');
                    yellowgrp.addChild(newBox); newBox.scale.setTo(1, 0.97);
                }
                y = yellowgrp.children.length > 0 ? yellowgrp.getChildAt(yellowgrp.children.length - 1).y - 27 : 410;
                for (i = 0; i < greenCn % 10; i++) {
                    x = i % 10 != 0 ? i % 10 * 21 + 6 * (Math.floor(i % 10) - 1) : -6
    ...
    DemoVideo: function () {
        ...
        // DEMO AUDIOS
        //* This game helps us multiply a decimal number with a whole number using the overlap method.
        _this.demoAudio1 = document.createElement('audio');
        _this.demoAudio1src = document.createElement('source');
        _this.demoAudio1src.setAttribute("src", window.baseUrl + "questionSounds/NSD-2-G7/" + _this.languageSelected + "/NDS_2_G7_d1.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //* This question can be read as, “what is 4 times 0.48?”
        _this.demoAudio2 = document.createElement('audio');
        _this.demoAudio2src = document.createElement('source');
        _this.demoAudio2src.setAttribute("src", window.baseUrl + "questionSounds/NSD-2-G7/" + _this.languageSelected + "/NDS_2_G7_d2.mp3");
        ...
        _this.demoAudio3src.setAttribute("src", window.baseUrl + "questionSounds/NSD-2-G7/" + _this.languageSelected + "/NDS_2_G7_d3.mp3");
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/NSD-2-G7/" +
            _this.languageSelected + "/NSD_2_G7_a1.mp3");
        _this.q1Sound.appendChild(_this.q1Soundsrc);

        //*  Now, overlap the multiplier over the multiplicand to get the final answer.
        _this.q2Sound = document.createElement('audio');
        _this.q2Soundsrc = document.createElement('source');
        _this.q2Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/NSD-2-G7/" +
            _this.languageSelected + "/NSD_2_G7_a2.mp3");
        _this.q2Sound.appendChild(_this.q2Soundsrc);

        //* Count and type the answer.
        _this.q3Sound = document.createElement('audio');
        _this.q3Soundsrc = document.createElement('source');
        _this.q3Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/NSD-2-G7/" +
            _this.languageSelected + "/NSD_2_G7_a3.mp3");
    ...
    dA3: function () {
        ...
        _this.q2Timer = setTimeout(function ()    //* q2 js timer to play 2 after 42 seconds.
        {
    ...
    dA4: function () {
        _this.demoAudio3Timer = setTimeout(function ()    //* demo audio3 js timer to play demo audio3 after 8 seconds.
        {
    ...
    dA5: function () {
        _this.q3Timer = setTimeout(function ()    //* q3 js timer to play 3 after 5.8 seconds.
        {
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1 = _this.add.video('NSD2G7');
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl + "assets/demoVideos/NSD-2-G7.mp4");
